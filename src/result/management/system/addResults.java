...
public class addResults extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String systemDesign = jTextField2.getText();
        ...
        String daa = jTextField7.getText();
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into result (rollNumber,systemDesign,maths,em,dbms,os,daa) values('"+rollNumber+"','"+systemDesign+"','"+maths+"','"+em+"','"+dbms+"','"+os+"','"+daa+"')");
                JOptionPane.showMessageDialog(this,"Data Saved Successfully");
                setVisible(false);
                new addResults().setVisible(true);
            }else{
                JOptionPane.showMessageDialog(this,"This Roll Number Doesn't Exist");
            }
        }catch(Exception e){
